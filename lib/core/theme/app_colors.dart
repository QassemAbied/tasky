...
abstract class AppColors {
  static const Color primaryColorDark = Color(0xFF15B86C);
  static const Color primaryTextDark = Color(0xFFFFFCFC);
  static const Color secondaryTextDark = Color(0xFFC6C6C6);
  static const Color tertiaryTextDark = Color(0xFFA0A0A0);
  ...
  static const Color secondaryTextLight = Color(0xFF3A4640);
  static const Color tertiaryTextLight = Color(0xFF6A6A6A);
